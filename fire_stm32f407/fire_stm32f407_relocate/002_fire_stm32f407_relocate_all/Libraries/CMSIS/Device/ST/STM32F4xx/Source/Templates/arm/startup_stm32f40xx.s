...
Reset_Handler    PROC
		...
		IMPORT |Image$$RW_IRAM2$$ZI$$Length|
				 ...
				 LDR	 R0, =|Image$$RW_IRAM2$$ZI$$Base|
				 LDR	 R1, =|Image$$RW_IRAM2$$ZI$$Length|
				 BL		 Bsp_Clear_Bss
...
clear_bss		PROC 
                IMPORT |Image$$RW_IRAM2$$ZI$$Base|    ; ZI段的链接起始地址
                IMPORT |Image$$RW_IRAM2$$ZI$$Length|  ; ZI段的长度
                ldr r0, =|Image$$RW_IRAM2$$ZI$$Base|  
                mov r1, #0
                ldr r2, =|Image$$RW_IRAM2$$ZI$$Length|
memset			
